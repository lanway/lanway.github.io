...
现在在[Linux](http://lib.csdn.net/base/linux) 2.6内核下开启文件打开数为65535，worker_rlimit_nofile就相应应该填写65535。
...
与apache相类，nginx针对不同的[操作系统](http://lib.csdn.net/base/operatingsystem)，有不同的事件模型
...
例：在upstream中加入hash语句，server语句中不能写入weight等其他的参数，hash_method是使用的hash[算法](http://lib.csdn.net/base/datastructure)
